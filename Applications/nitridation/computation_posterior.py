...
res = scipy.optimize.minimize(model.m_log_likelihood,Xi,method='Nelder-Mead',tol=1e-6)
print("MAP found at: "+str(res.x))

# MCMC sampling
nburn = 10000
sampler = mcmc.metropolis(np.identity(len(model.hyp))*0.01,model.log_likelihood,nburn)
