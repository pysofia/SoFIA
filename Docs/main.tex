...
\noindent\textbf{\small Forward uncertainty propagation (\texttt{Fprop}).} Under development. It will include a simple polynomial chaos construction. Sample-based methods can be built with the functionalities already included. \\
