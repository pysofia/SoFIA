...
class assembly:
    ...
    def __init__(self,data_json,models_json,mixture):
        ...
        self.mix = mixture
        ##
        self.rec = pickle.load(open(self.models[sys.argv[2]][sys.argv[3]][sys.argv[1]][0], 'rb'))
        self.temp = pickle.load(open(self.models[sys.argv[2]]["SEB"][sys.argv[1]][2], 'rb'))
        self.rho = pickle.load(open(self.models[sys.argv[2]][sys.argv[3]][sys.argv[1]][1], 'rb'))
